...
class DemoData:
    def __init__(self) -> None:
        ...
        self.risk_flags = [RiskFlag.model_validate(value) for value in _read("risk.sample.json")]
        self.escalations = [
    ...
    def list_risk_flags(self, document_id: str) -> list[RiskFlag]:
        return [flag for flag in self.risk_flags if flag.document_id == document_id]
